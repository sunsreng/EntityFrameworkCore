        ...
        NavigationAttributeEntityTypeConvention<InversePropertyAttribute>, IModelBuiltConvention
    {
            ...
            InversePropertyAttribute attribute)
        {
            ...
            if (IsAmbiguousInverse(navigationMemberInfo, entityType.ClrType, entityType.Model, referencingNavigationsWithAttribute))
            {
                ...
                if (existingInverse != null
                    && IsAmbiguousInverse(
                        existingInverse.GetDefiningMemberInfo(), existingInverseType, entityType.Model, referencingNavigationsWithAttribute))
                {
            ...
            if (ownership != null
                ...
                && ownership.PrincipalToDependent?.GetDefiningMemberInfo() != inverseNavigationPropertyInfo)
            {
                _logger.NonOwnershipInverseNavigation(entityType, navigationMemberInfo,
                    ...
                    ownership.PrincipalToDependent.GetDefiningMemberInfo());
                return null;
            }
            ...
            InternalRelationshipBuilder relationshipBuilder, Navigation navigation, InversePropertyAttribute attribute)
        {
            ...
            return ConfigureInverseNavigation(
                navigation.DeclaringEntityType.Builder, navigation.GetDefiningMemberInfo(), navigation.GetTargetType().Builder, attribute);
        }
